...
class Product extends Model{
	...
	public function save()
	{
		...
		$results = $sql->select("CALL sp_products_save(:idproduct, :desproduct, :vlprice, :vlwidth, :vlheight, :vllength, :vlwight, :desurl)", array(
	...
	{
		if (file_exists($_SERVE['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "res" .
		DIRECTORY_SEPARATOR . "site" . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR .
	...
	public function setPhoto($file)
	{
		...
		$destino = $_SERVE['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "res" .
		DIRECTORY_SEPARATOR . "site" . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR .
		"products" . DIRECTORY_SEPARATOR . $this->getidproduct() . ".jpg";
